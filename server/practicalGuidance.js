const TOPIC_RULES = [
  ...
  {
    name: "mediacao",
    terms: ["mediar", "mediador", "mediacao", "facilitar", "duas pessoas", "ajudar duas", "conduzir", "conversa dificil", "neutralidade", "ninguém quer ceder", "ninguem quer ceder"],
    answer:
  ...
  },
  {
    ...
    terms: ["bullying", "excluido", "excluida", "ameaca", "ameacado", "ameacada", "agressao", "violencia", "injustica", "denuncia", "autoridade", "adulto", "pedir ajuda"],
    answer:
  ...
  {
    name: "cnv",
    terms: ["magoar", "feedback", "agressivo", "rude", "pedir", "cnv", "comunicacao", "frase", "assertiva", "empatica"],
    answer:
  ...
  },
  {
    ...
    terms: ["briguei", "briga", "conflito", "desculpa", "dialogar", "colega", "trabalho", "resolver", "ceder"],
    answer:
  ...
  {
    name: "convivencia",
    terms: ["pessoas", "dificeis", "opiniao", "opinioes", "desrespeita", "desrespeito", "ambiente", "sala", "respeitar", "limites"],
    answer:
  ...
  {
    name: "bullying e violencia",
    terms: ["bullying", "excluido", "excluida", "ameaca", "ameacado", "ameacada", "agressao", "violencia", "injustica", "denuncia", "autoridade", "adulto"],
    answer:
      "Se há bullying, ameaça, agressão ou humilhação repetida, não trate isso como uma briga comum. Procure apoio de alguém confiável, como família, professor, coordenação, liderança ou autoridade responsável. Guarde registros se for seguro, evite enfrentar sozinho e peça ajuda. Em risco imediato, priorize sua segurança e procure uma autoridade ou serviço de emergência."
  },
  {
    name: "pratica da paz",
    terms: ["praticar", "atitudes", "simples", "grupo", "incentivar", "cooperação", "solidariedade", "cotidiano"],
    answer:
  ...
  {
    name: "reflexao etica",
    terms: ["por que", "justica", "evitar", "todas", "brigas", "ausencia", "paz", "conflito", "conflitos"],
    answer:
  ...
  {
    name: "simulacao",
    terms: ["simule", "simular", "responder", "ofendeu", "dizer", "roleplay", "treinar", "conversa"],
    answer:
  ...
  },
  {
    ...
    terms: ["sozinho", "sozinha", "ninguem", "entende", "frustracao", "triste", "cansado", "cansada", "desanimado", "desanimada"],
    answer:
  ...
  },
  {
    ...
    terms: ["explique", "simples", "principios", "onu", "agressividade", "assertividade", "resumo", "estudo"],
    answer:
